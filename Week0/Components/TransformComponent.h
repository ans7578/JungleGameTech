...
public:
    ...
    void            SetPosition(const XMFLOAT3& position) { m_fPosition = position; }
    void            SetRotation(const XMFLOAT3& rotation) { m_fRotation = rotation; }
    void            SetScale(const XMFLOAT3& scale) { m_fScale = scale; }
